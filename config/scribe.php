...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your access token by calling the login or register endpoints. Include the token in the Authorization header as "Bearer YOUR_ACCESS_TOKEN".',
    ],
