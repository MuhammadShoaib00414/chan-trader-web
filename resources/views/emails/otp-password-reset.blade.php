...
@section('title', 'Password reset code — '.config('app.name'))
        ...
        <tr>
            <td style="padding-bottom:14px;">
                <p style="margin:0; font-family:Arial,Helvetica,sans-serif; color:#cbd5e1; font-size:14px; line-height:1.6;">
                    Enter the code below in the app to continue resetting your password.
                </p>
            </td>
        </tr>
        <tr>
            <td align="center" style="padding:10px 0 16px;">
                <div style="display:inline-block; padding:14px 18px; border-radius:10px; background:#0f172a; border:1px solid #1f2a44;">
                    <span style="letter-spacing:6px; font-size:28px; color:#22d3ee; font-weight:700; font-family:Arial,Helvetica,sans-serif;">
                        {{ $otp }}
                    </span>
                </div>
            </td>
        ...
        <tr>
            <td>
                <p style="margin:0; font-family:Arial,Helvetica,sans-serif; color:#94a3b8; font-size:12px; line-height:1.6;">
                    This code expires in {{ config('app.otp_expire_time') }} minutes. If you didn’t request a reset, you can safely ignore this email.
                </p>
            </td>
        </tr>
    </table>
